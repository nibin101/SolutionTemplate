...
This module is the concrete implementation of the PMS seam that
docs/architecture.md (6) describes. It is deliberately NOT wired into
app.capture yet: charting behaviour is unchanged, and forwarding a charted
image to CareStack is an explicit follow-up step, not a silent side effect
of ingest. See docs/camera-workflow-plan.md (1.4) for the API research.
...
(upload_image) so switching from mock to real is a one-line change.
